...
length( d[d$QID==1 & d$Machi==1, "newID"] )
length( d[d$QID==1 & d$Machi==0, "newID"] )

length( d[d$QID==2 & d$Machi==1, "newID"] )
length( d[d$QID==2 & d$Machi==0, "newID"] )

length( d[d$QID==3 & d$Machi==1, "newID"] )
length( d[d$QID==3 & d$Machi==0, "newID"] )

length( d[d$QID==4 & d$Machi==1, "newID"] )
length( d[d$QID==4 & d$Machi==0, "newID"] )

length( d[d$QID==5 & d$Machi==1, "newID"] )
length( d[d$QID==5 & d$Machi==0, "newID"] )

length( d[d$QID==6 & d$Machi==1, "newID"] )
length( d[d$QID==6 & d$Machi==0, "newID"] )

length( d[d$QID==7 & d$Machi==1, "newID"] )
length( d[d$QID==7 & d$Machi==0, "newID"] )

length( d[d$QID==8 & d$Machi==1, "newID"] )
length( d[d$QID==8 & d$Machi==0, "newID"] )

length( d[d$QID==9 & d$Machi==1, "newID"] )
length( d[d$QID==9 & d$Machi==0, "newID"] )
length( d[d$QID==9 & d$Community=="B", "newID"] )
length( d[d$QID==9 & d$Community=="A", "newID"] ) #just asked in Atalaya, including 2 Matsi

length( d[d$QID==10 & d$Machi==1, "newID"] )
length( d[d$QID==10 & d$Machi==0, "newID"] )

length( d[d$QID==11 & d$Machi==1, "newID"] )
length( d[d$QID==11 & d$Machi==0, "newID"] )

length( d[d$QID==12 & d$Machi==1, "newID"] )
length( d[d$QID==12 & d$Machi==0, "newID"] )
length( d[d$QID==12 & d$Community=="B", "newID"] )
length( d[d$QID==12 & d$Community=="A", "newID"] ) #just asked in Atalaya, including 2 Matsi

length( d[d$QID==13 & d$Machi==1, "newID"] )
length( d[d$QID==13 & d$Machi==0, "newID"] )

length( d[d$QID==14 & d$Machi==1, "newID"] )
length( d[d$QID==14 & d$Machi==0, "newID"] )
...
pdf(file="~/Matsi_IRT/IRT_analysis/Fig2_raw_props.pdf", 
height=4, width=4)
par(mfrow=c(1,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m1.pdf", 
  height=3, width=8)
par(mfrow=c(2,1))
...
#look at all plots
pdf(file="~/Matsi_IRT/IRT_analysis/FigB1_logistic_m1.pdf", 
  height=10, width=12)
...
#individual location highlights
pdf(file="~/Matsi_IRT/IRT_analysis/FigC1_m1.pdf",
    height=2, width=6)
...
pdf(file="~/Matsi_IRT/IRT_analysis/Fig3_m1.pdf", 
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m2.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m3.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m4.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m5.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m6.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m7.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m8.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m9.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m10.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m11.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m12.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m13.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m14.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m15.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m16.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m17.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m18.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces
pdf(file="~/Matsi_IRT/IRT_analysis/traces_m19.pdf") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#dotplot of parameter estimates
pdf(file="~/Matsi_IRT/IRT_analysis/FigB3_params_dens.pdf", 
height=5, width=6)
par(mfrow=c(1,1))
...
#dotplot of contrasts
pdf(file="~/Matsi_IRT/IRT_analysis/Fig4_contrasts_dens.pdf", 
height=5, width=6)
par(mfrow=c(1,1))
...
##plot discrimination posterior estimates for m19
...
#dotplot of discrimination estimates
pdf(file="~/Matsi_IRT/IRT_analysis/FigB2_disc_dens.pdf", 
height=5, width=7.5)
par(mfrow=c(1,1))
...
denschart( disc_list , adjust=1 , color= grey(0.25), #"slateblue" ,
          border=NA, yaxt="n",
          cex=0.8, height=0.7,
          xlim=range( min(unlist(par_list))+1.5, 3)#max(unlist(par_list))-4 ) 
 )

title(xlab="Effect Size on Latent Axis", cex.lab=0.8, adj=0.90,
      line=2.3)
...
stargazer(tab_mat, summary=FALSE, rownames=FALSE, type="text",
          out="~/Matsi_IRT/IRT_analysis/table.txt")
