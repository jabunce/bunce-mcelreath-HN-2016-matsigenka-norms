...
#posterior parameter estimates and model WAIC weights.
...
#look at all traces (warnings for use of Arial font can be ignored)
postscript(file="./traces_m1.eps",
  height=3, width=8)
par(mfrow=c(2,1))
...
#look at all traces (warnings for use of Arial font can be ignored)
postscript(file="./traces_m10.eps") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces (warnings for use of Arial font can be ignored)
postscript(file="./traces_m11.eps") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces (warnings for use of Arial font can be ignored)
postscript(file="./traces_m12.eps") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces (warnings for use of Arial font can be ignored)
postscript(file="./traces_m13.eps") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces (warnings for use of Arial font can be ignored)
postscript(file="./traces_m14.eps") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces (warnings for use of Arial font can be ignored)
postscript(file="./traces_m15.eps") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces (warnings for use of Arial font can be ignored)
postscript(file="./traces_m16.eps") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces (warnings for use of Arial font can be ignored)
postscript(file="./traces_m17.eps") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces (warnings for use of Arial font can be ignored)
postscript(file="./traces_m18.eps") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
...
#look at all traces (warnings for use of Arial font can be ignored)
postscript(file="./traces_m19.eps") #, 
  #height=10, width=8)
par(mfrow=c(2,1))
